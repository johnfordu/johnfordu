...
<body class="min-h-screen flex flex-col">
    <header class="navbar text-red-600 p-4 shadow-lg">
        <div class="max-w-6xl mx-auto flex justify-between items-center">
            ...
            <nav>
                <a href="<?php echo e(route('movies.index')); ?>" class="mr-6 hover:text-white transition">Home</a>
                <a href="<?php echo e(route('movies.create')); ?>" class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded transition">Add Movie</a>
            </nav>
        </div>
    </header>
    ...
    <footer class="bg-[#141414] text-gray-500 text-center p-4 mt-auto border-t border-red-900/30">
        © <?php echo e(date('Y')); ?> <span class="text-red-600 font-bold">MyNetflix</span> 🎬
    </footer>
</body>
</html>
<?php /**PATH C:\Users\user\Ubina_Quiz\resources\views/layouts/app.blade.php ENDPATH**/ ?>